...
from sending.forms import MailForm, MessageForm, ClientForm, MailModeratorForm
from sending.models import Message, Mail, Client, Logs
from sending.services import get_cache_for_mailings, get_cache_for_active_mailings


class MailCreateView(LoginRequiredMixin, CreateView):
    model = Mail
    form_class = MailForm
    success_url = reverse_lazy('sending:mail_list')
    extra_context = {
...
class MailUpdateModeratorView(LoginRequiredMixin, PermissionRequiredMixin, UpdateView):
    ...
    success_url = reverse_lazy('sending:mail_list')
    permission_required = 'sending.set_is_activated'
...
class MessageUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        return reverse('sending:message_view', args=[self.kwargs.get('pk')])
